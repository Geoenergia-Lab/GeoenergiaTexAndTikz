...
\end{subfigure}
\caption{Domain decomposition strategies for parallel computation. Separate colours refer to separate device partitions. Tikz source code: Tikz/decompStrategies.tex}
