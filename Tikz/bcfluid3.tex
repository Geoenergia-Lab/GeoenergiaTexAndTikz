...
\begin{tikzpicture}[line width=0.2mm]
	...
	\fill[gray!20] (8,4) -- (8,6) -- (6,6) -- cycle;
	\fill[pattern=north east lines, pattern color=black!60] (8,4) -- (8,6) -- (6,6) -- cycle;

	\draw[solid,thin,line width=0.2mm, black!50 ] (8,4) -- (6,6);
	...
	\draw[solid,thin,line width=0.2mm, gray!20] (4,6) -- (6,6);

	\draw[solid,thin,line width=0.2mm, gray!20] (6,2) -- (6,6);
	\draw[solid,thin,line width=0.2mm, gray!20] (8,2) -- (8,4);
	...
	\draw (6,1.5)node[]{$I_s = \{0,1,2,3,4,5,6,8\}$};
	%\draw (6,1)node[]{$O_s = \{0,1,2,3,4,6,7,8\}$};
