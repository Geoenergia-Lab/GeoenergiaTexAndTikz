...
\tikzset{myblue/.style={draw=black, fill=white, line width=0.4mm, circle, minimum size=0.3cm, inner sep=0pt}}

% Horizontal and vertical grid lines
\foreach \y in {1,...,19} {
	\draw[gray!20, line width=0.1mm] (1,\y) -- (19,\y);
}
\foreach \x in {1,...,19} {
	\draw[gray!20, line width=0.1mm] (\x,1) -- (\x,19);
}
...
\tikzset{mydot/.style={draw=black, fill=black, line width=0mm, circle, minimum size=0.35cm, inner sep=0pt}}
...
\draw[dashed, line width=0.2mm] (p1) -- (p2) -- (p3) -- (p4) -- (p5) -- (p6) -- (p7) -- (p10) -- (p11) -- (p14) -- (p15) -- (p18) -- (p19) -- (p22) -- (p23) -- (p25) -- (p27) -- (p29) -- (p31) -- (p33) -- (p37) -- (p36) -- (p41) -- (p40) -- (p45) -- (p44) -- (p49) -- (p48) -- (p56) -- (p55) -- (p54) -- (p53) -- (p52) -- (p51) -- (p50) -- (p47) -- (p46) -- (p43) -- (p42) -- (p39) -- (p38) -- (p35) -- (p34) -- (p32) -- (p30) -- (p28) -- (p26) -- (p24) -- (p20) -- (p21) -- (p16) -- (p17) -- (p12) -- (p13) -- (p8) -- (p9) -- (p1) -- cycle;



%Bc fluid
\tikzset{myblue2/.style={draw=black, fill=black, line width=0.5mm, circle, minimum size=0.3cm, inner sep=0pt}}
\tikzset{mygray/.style={draw=gray!20, fill=gray!20, line width=0.5mm, circle, minimum size=0.25cm, inner sep=0pt}}
...
\foreach \y in {8,...,12} { \node[mydiamond] at (4,\y) {}; }
\foreach \y in {7,...,13} { \node[mydiamond] at (5,\y) {}; }
\foreach \y in {6,...,14} { \node[mydiamond] at (6,\y) {}; }
\foreach \y in {5,...,15} { \node[mydiamond] at (7,\y) {}; }
\foreach \y in {4,...,16} { \node[mydiamond] at (8,\y) {}; }
\foreach \y in {4,...,16} { \node[mydiamond] at (9,\y) {}; }
\foreach \y in {4,...,16} { \node[mydiamond] at (10,\y) {}; }
\foreach \y in {4,...,16} { \node[mydiamond] at (11,\y) {}; }
\foreach \y in {4,...,16} { \node[mydiamond] at (12,\y) {}; }
\foreach \y in {5,...,15} { \node[mydiamond] at (13,\y) {}; }
\foreach \y in {6,...,14} { \node[mydiamond] at (14,\y) {}; }
\foreach \y in {7,...,13} { \node[mydiamond] at (15,\y) {}; }
\foreach \y in {8,...,12} { \node[mydiamond] at (16,\y) {}; }


\draw (1,21) node[anchor=west] { \tikz{\node[myblue] {};} {\Large\textbf{Fluid node} }};
\draw (8,21) node[anchor=west] { \tikz{\node[mydot] {};} {\Large\textbf{Boundary node} }};
\draw (15,21) node[anchor=west] { \tikz{\node[mydiamond] {};} {\Large\textbf{Solid node} }};
%\draw (0,21) node[anchor=west] { \tikz{\node[myblue2] {};} {\Large\textbf{Fluid node with missing neighbour} }};
\draw (1,20) node[anchor=west] { \tikz{\draw[black,thick, line width=0.8mm] (0,0.8) -- (1.5,0.8);} {\Large\textbf{Physical boundary}} };
