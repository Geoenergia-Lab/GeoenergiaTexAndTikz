...
\begin{tikzpicture}[line width=0.4mm][>=Latex]
    ...
    \draw[solid,thick,line width=0.6mm] (2,8) -- (4,6);
    \draw[solid,thick,line width=0.6mm] (4,6) -- (6,4);
    \draw[solid,thick,line width=0.6mm] (6,4) -- (8,2);
    \draw[solid,thick,line width=0.6mm] (8,2) -- (10,0);
    \draw[solid,thick,line width=0.6mm] (10,0) -- (12,-2);

    %white lines
    %\draw[white,solid,thick,line width=0.4mm] (4,6) -- (4,4);
    %\draw[white,solid,thick,line width=0.4mm] (4,4) -- (6,4);
    %\draw[white,solid,thick,line width=0.4mm] (6,4) -- (6,2);
    %\draw[white,solid,thick,line width=0.4mm] (6,2) -- (8,2);
    %\draw[white,solid,thick,line width=0.4mm] (8,2) -- (8,0);
    %\draw[white,solid,thick,line width=0.4mm] (8,0) -- (10,0);

    \fill[black!20] (2,8) -- (2,6) -- (4,6) -- cycle;
    \fill[pattern=north east lines, pattern color=black!50]
    (2,8) -- (2,6) -- (4,6) -- cycle;

    \fill[black!20] (10,0) -- (10,-2) -- (12,-2) -- cycle;
    \fill[pattern=north east lines, pattern color=black!50]
    (10,0) -- (10,-2) -- (12,-2) -- cycle;

    \fill[black!20] (6,4) -- (4,4) -- (4,6) -- cycle;
    \fill[pattern=north east lines, pattern color=black!50]
    (6,4) -- (4,4) -- (4,6) -- cycle;

    \fill[black!20] (8,2) -- (6,2) -- (6,4) -- cycle;
    \fill[pattern=north east lines, pattern color=black!50]
    (8,2) -- (6,2) -- (6,4) -- cycle;

    \fill[black!20] (10,0) -- (8,0) -- (8,2) -- cycle;
    \fill[pattern=north east lines, pattern color=black!50]
    (10,0) -- (8,0) -- (8,2) -- cycle;
    ...
    %
    %\fill[pattern=north east lines, pattern color=black!50]
    %(10,0) -- (12,0) --(12,-2)-- cycle;

    %top first row
    \draw[black,fill=black] (2,8)node[]{} circle(0.15cm);
    \node[draw, black, fill=white, rectangle, minimum size=0.15cm] at (4,8) {};
    ...
    \node[draw, black, fill=white, rectangle, minimum size=0.2cm] at (6,6) {};
    ...
    %\node [draw, black!20, fill=gray,diamond, aspect=1,scale=0.5] at (4,4) {};

    \draw[black,fill=black] (6,4)node[]{} circle(0.15cm);
    \node[draw, black, fill=white, rectangle, minimum size=0.2cm] at (8,4) {};
    ...
    %\node [draw, black!20, fill=gray,diamond, aspect=1,scale=0.5] at (6,2) {};
    \draw[black,fill=black] (8,2)node[]{} circle(0.15cm);
    \node[draw, black, fill=white, rectangle, minimum size=0.2cm] at (10,2) {};
    ...
    %\node [draw, black!20, fill=gray,diamond, aspect=1,scale=0.5] at (8,0) {};
    \draw[black,fill=black] (10,0)node[]{} circle(0.15cm);
    \node[draw, black, fill=white, rectangle, minimum size=0.2cm] at (12,0) {};
    ...
    \tikzset{bcfluid_node/.style={draw=black, fill=white,line width=0.4mm, rectangle, minimum size=0.3cm, inner sep=0pt}}
    ...
    \draw (2,9) node[anchor=west] { \tikz{\node[bcfluid_node] {};} {\large\textbf{Fluid node with triangular lattice}} };
